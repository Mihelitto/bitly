...
- Запустите программу командой `python3 main.py https://www.google.ru/`, где аргументом указывается ссылка для сокращения или короткая ссылка.
- Для вызова справки воспользуйтесь командой `python3 main.py -h`
